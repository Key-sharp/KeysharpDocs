indexData = [
  ...
  ["__Enum method (ComObjArray)","lib/ComObjArray.htm#__Enum",7],
  ...
  ["__Item property (ComObjArray)","lib/ComObjArray.htm#__Item",7],
  ...
  ["__Ref method (Object)","lib/Object.htm#__Ref",7],
  ["__Ref method (Struct)","lib/Struct.htm#__Ref",7],
  ["__Set meta-function","Objects.htm#Meta_Functions"],
  ["__Value property (struct)","Structs.htm#abstract",7],
  ["__Value property (VarRef)","Concepts.htm#variable-references",7],
  ...
  ["??=","Variables.htm#maybe-assign",4,"",true],
  ...
  ["#App","lib/_App.htm",0,"S"],
  ["Application manifest","lib/_App.htm",0,""],
  ["#CSharp","lib/_CSharp.htm",0,"S"],
  ["Inline C#","lib/_CSharp.htm",0,""],
  ["#Define","lib/KeysharpDirectives.htm#Conditional",0,"S"],
  ["#DllLoad","lib/_DllLoad.htm",0,"S"],
  ["#Else","lib/KeysharpDirectives.htm#Conditional",0,""],
  ["#ElIf","lib/KeysharpDirectives.htm#Conditional",0,"E"],
  ["#EndIf","lib/KeysharpDirectives.htm#Conditional",0,""],
  ["#Error","lib/KeysharpDirectives.htm#Error",0,"S"],
  ...
  ["#If","lib/KeysharpDirectives.htm#Conditional",0,"E"],
  ["conditional compilation","lib/KeysharpDirectives.htm#Conditional"],
  ["#Import","lib/_Import.htm",0,"E"],
  ...
  ["#Module","lib/_Module.htm",0,"S"],
  ["#NoTrayIcon","lib/_NoTrayIcon.htm",0,""],
  ["#Package","lib/_Package.htm",0,"S"],
  ["NuGet","lib/_Package.htm",0,""],
  ["Package providers","lib/_Package.htm",0,""],
  ["Clr.LoadPackage","lib/Clr.htm#LoadPackage",7,""],
  ["#Requires","lib/_Requires.htm",0,"S"],
  ["#SingleInstance","lib/_SingleInstance.htm",0,"S"],
  ["#StructPack","lib/_StructPack.htm",0,"S"],
  ["#SuspendExempt","lib/_SuspendExempt.htm",0,"S"],
  ["#TrayIcon","lib/_TrayIcon.htm",0,"S"],
  ["#UseHook","lib/_UseHook.htm",0,"S"],
  ["#Undef","lib/KeysharpDirectives.htm#Conditional",0,"S"],
  ["#Warn","lib/_Warn.htm",0,"SS"],
  ["#Warning","lib/KeysharpDirectives.htm#Error",0,"S"],
  ...
  ["A_ClipboardTimeout","Variables.htm#A_ClipboardTimeout",3],
  ...
  ["A_HotIfTimeout","Variables.htm#A_HotIfTimeout",1],
  ...
  ["A_InputLevel","Variables.htm#A_InputLevel",1],
  ...
  ["A_IsPersistent","Variables.htm#A_IsPersistent",1],
  ["A_IsSuspended","Variables.htm#IsSuspended",1],
  ["A_IsUnicode","Variables.htm#A_IsUnicode",1],
  ["A_KeybdHookInstalled","Variables.htm#HookInstalled",1],
  ...
  ["A_KsVersion","Variables.htm#A_KsVersion",1],
  ...
  ["A_LoopFileLongPath","Variables.htm#A_LoopFileLongPath",1],
  ...
  ["A_LoopKey","Variables.htm#A_LoopKey",1],
  ...
  ["A_MaxThreadsBuffer","Variables.htm#A_MaxThreadsBuffer",1],
  ["A_MaxThreadsPerHotkey","Variables.htm#A_MaxThreadsPerHotkey",1],
  ...
  ["A_PeekFrequency","Variables.htm#A_PeekFrequency",1],
  ...
  ["A_Thread","Variables.htm#Thread",3],
  ["A_RealThread","Variables.htm#Thread",3],
  ...
  ["Any","lib/Any.htm",6],
  ["App class","lib/App.htm",6],
  ["App.CommandLine","lib/App.htm#CommandLine",7],
  ["App.Company","lib/App.htm#Company",7],
  ["App.Configuration","lib/App.htm#Configuration",7],
  ["App.Copyright","lib/App.htm#Copyright",7],
  ["App.Description","lib/App.htm#Description",7],
  ["App.ExitCode","lib/App.htm#ExitCode",7],
  ["App.ExitReason","lib/App.htm#ExitReason",7],
  ["App.Name","lib/App.htm#Name",7],
  ["App.Product","lib/App.htm#Product",7],
  ["App.Title","lib/App.htm#Title",7],
  ["App.Trademark","lib/App.htm#Trademark",7],
  ["App.Version","lib/App.htm#Version",7],
  ["append to file","lib/FileAppend.htm"],
  ["Args property (PropRef)","lib/PropRef.htm#Args",7],
  ["Array","lib/Array.htm",6],
  ["Array","lib/Array.htm#Call",2],
  ["Arrays (general information)","Objects.htm"],
  ["as","Concepts.htm#reserved-words",4],
  ["as (Catch)","lib/Catch.htm"],
  ["as (#Import)","lib/_Import.htm"],
  ["ASin","lib/Math.htm#ASin",2],
  ["assigning values to variables","Variables.htm#AssignOp"],
  ["At method (Struct)","lib/Struct.htm#At",7],
  ...
  ["Audio class","lib/Audio.htm",6],
  ["Audio.Clip object","lib/Audio.htm#Clip",6],
  ["Audio.DefaultDevice","lib/Audio.htm#DefaultDevice",5],
  ["Audio.Device object","lib/Audio.htm#Device",6],
  ["Audio.Device.Mute","lib/Audio.htm#Device",7],
  ["Audio.Device.Refresh","lib/Audio.htm#Device",5],
  ["Audio.Device.ToClr","lib/Audio.htm#Device",5],
  ["Audio.Device.Volume","lib/Audio.htm#Device",7],
  ["Audio.Devices","lib/Audio.htm#Devices",5],
  ["Audio.FromPcm","lib/Audio.htm#FromPcm",5],
  ["Audio.IsDeviceChangeSupported","lib/Audio.htm#IsDeviceChangeSupported",7],
  ["Audio.IsFormatSupported","lib/Audio.htm#IsFormatSupported",5],
  ["Audio.IsInputAvailable","lib/Audio.htm#IsInputAvailable",7],
  ["Audio.IsMeteringSupported","lib/Audio.htm#IsMeteringSupported",7],
  ["Audio.IsMicrophoneCaptureSupported","lib/Audio.htm#IsMicrophoneCaptureSupported",7],
  ["Audio.IsOutputAvailable","lib/Audio.htm#IsOutputAvailable",7],
  ["Audio.IsPlaybackSupported","lib/Audio.htm#IsPlaybackSupported",7],
  ["Audio.IsSessionControlSupported","lib/Audio.htm#IsSessionControlSupported",7],
  ["Audio.IsSystemAudioCaptureSupported","lib/Audio.htm#IsSystemAudioCaptureSupported",7],
  ["Audio.Load","lib/Audio.htm#Load",5],
  ["Audio.Meter object","lib/Audio.htm#Meter",6],
  ["Audio.Meter.Peak","lib/Audio.htm#Meter",7],
  ["Audio.Meter.Start","lib/Audio.htm#Meter",5],
  ["Audio.Meter.Stop","lib/Audio.htm#Meter",5],
  ["Audio.OnDeviceChange","lib/Audio.htm#OnDeviceChange",5],
  ["Audio.Output object","lib/Audio.htm#Output",6],
  ["Audio.Output.Open","lib/Audio.htm#OutputOpen",5],
  ["Audio.Output.Play","lib/Audio.htm#OutputPlay",5],
  ["Audio.Output.Prepare","lib/Audio.htm#OutputMembers",5],
  ["Audio.Output.StopAll","lib/Audio.htm#OutputStopAll",5],
  ["Audio.Output.TryOpen","lib/Audio.htm#OutputMembers",5],
  ["Audio.Output.VoicePolicy","lib/Audio.htm#VoicePolicy",7],
  ["Audio.Output.Volume","lib/Audio.htm#OutputMembers",7],
  ["Audio.Play","lib/Audio.htm#Play",5],
  ["Audio.Playback object","lib/Audio.htm#Playback",6],
  ["Audio.Playback.Pause","lib/Audio.htm#Playback",5],
  ["Audio.Playback.PositionMilliseconds","lib/Audio.htm#Playback",7],
  ["Audio.Playback.Resume","lib/Audio.htm#Playback",5],
  ["Audio.Playback.Stop","lib/Audio.htm#PlaybackStop",5],
  ["Audio.Recorder object","lib/Audio.htm#Recorder",6],
  ["Audio.Recorder.Start","lib/Audio.htm#Recorder",5],
  ["Audio.Recorder.Stop","lib/Audio.htm#Recorder",5],
  ["Audio.Recording object","lib/Audio.htm#Recording",6],
  ["Audio.Session object","lib/Audio.htm#Session",6],
  ["Audio.Session.Refresh","lib/Audio.htm#Session",5],
  ["Audio.Session.Volume","lib/Audio.htm#Session",7],
  ["Audio.Sessions","lib/Audio.htm#Sessions",5],
  ["Audio.SetApplicationMute","lib/Audio.htm#SetApplicationMute",5],
  ["Audio.SetApplicationVolume","lib/Audio.htm#SetApplicationVolume",5],
  ["auto-execute thread","Scripts.htm#auto"],
  ["auto-replace text as you type it","Hotstrings.htm"],
  ["Await","lib/Await.htm",2],
  ["BackColor property (Gui)","lib/Gui.htm#BackColor",7],
  ["BackColor property (Gui.Control)","lib/GuiControl.htm#BackColor",7],
  ["BackspaceIsUndo property (InputHook)","lib/InputHook.htm#BackspaceIsUndo",7],
  ["BeforeHotkeys property (InputHook)","lib/InputHook.htm#BeforeHotkeys",7],
  ...
  ["Boolean","lib/Boolean.htm",6],
  ["Boolean()","lib/Boolean.htm#Call",2],
  ["BoundFunc","misc/Functor.htm#BoundFunc",6],
  ["Break","lib/Break.htm",3,"S"],
  ["Buffer","lib/Buffer.htm",6],
  ["Buffer","lib/Buffer.htm#Call",2],
  ["BufferLengthMax property (InputHook)","lib/InputHook.htm#BufferLengthMax",7],
  ...
  ["Call method (File)","lib/File.htm#Call",7],
  ...
  ["Capacity property (StringBuffer)","lib/StringBuffer.htm#Capacity",7],
  ...
  ["ClassNN","misc/ControlID.htm#ClassNN"],
  ...
  ["Contains method (Array)","lib/Array.htm#Contains",7],
  ...
  ["ComponentAvailable","lib/ComponentAvailable.htm",2],
  ...
  ["contains","Variables.htm#is_in_contains",4],
  ["ContextMenu (Gui event)","lib/GuiOnEvent.htm#ContextMenu"],
  ["continuation sections","Scripts.htm#continuation"],
  ["combination keys","KeyList.htm#chord"],
  ["Copilot key","KeyList.htm#Copilot"],
  ...
  ["ControlID parameter","misc/ControlID.htm"],
  ...
  ["Clipboard class","lib/Clipboard.htm",6],
  ["Clipboard.All","lib/Clipboard.htm#All",7],
  ["Clipboard.Clear","lib/Clipboard.htm#Clear",5],
  ["Clipboard.Files","lib/Clipboard.htm#Files",7],
  ["Clipboard.Formats","lib/Clipboard.htm#Formats",7],
  ["Clipboard.GetData","lib/Clipboard.htm#GetData",5],
  ["Clipboard.Has","lib/Clipboard.htm#Has",5],
  ["Clipboard.Html","lib/Clipboard.htm#Html",7],
  ["Clipboard.Image","lib/Clipboard.htm#Image",7],
  ["Clipboard.IsEmpty","lib/Clipboard.htm#IsEmpty",7],
  ["Clipboard.OnChange","lib/Clipboard.htm#OnChange",5],
  ["Clipboard.Rtf","lib/Clipboard.htm#Rtf",7],
  ["Clipboard.Set","lib/Clipboard.htm#Set",5],
  ["Clipboard.Text","lib/Clipboard.htm#Text",7],
  ["Clipboard.Wait","lib/Clipboard.htm#Wait",5],
  ["ClipboardHook object","lib/Clipboard.htm#ClipboardHook",6],
  ["Cos","lib/Math.htm#Cos",2],
  ["Count property (Enumerator)","lib/Enumerator.htm#Count",7],
  ...
  ["Crypt class","lib/Crypto.htm"],
  ["cryptographic hash","lib/Crypto.htm#Hash"],
  ...
  ["D-Bus (Linux)","Platforms.htm#Linux_DBus"],
  ...
  ["DelegateHolder","lib/CallbackCreate.htm#DelegateHolder",6],
  ...
  ["Dimensions property (ComObjArray)","lib/ComObjArray.htm#Dimensions",7],
  ["digit","lib/Is.htm"],
  ...
  ["DPIChange (Gui event)","lib/GuiOnEvent.htm#DPIChange"],
  ["DPIResize (Gui control option)","lib/Gui.htm#DPIResize"],
  ["DPIResize (Gui option)","lib/Gui.htm#Gui_DPIResize"],
  ...
  ["EndCharMode property (InputHook)","lib/InputHook.htm#EndCharMode",7],
  ...
  ["ExitCode property (ProcessInfo)","lib/RunScript.htm#ExitCode",7],
  ["ExitTime property (ProcessInfo)","lib/RunScript.htm#ExitTime",7],
  ["Exp","lib/Math.htm#Exp",2],
  ["export","lib/_Import.htm#Export"],
  ...
  ["FileCreateTemp","lib/FilePath.htm#FileCreateTemp",2],
  ["FileDelete","lib/FileDelete.htm",2],
  ["FileDirName","lib/FilePath.htm",2],
  ["FileEncoding","lib/FileEncoding.htm",2],
  ["FileExist","lib/FileExist.htm",2],
  ["FileFullPath","lib/FilePath.htm",2],
  ...
  ["Flush method (File)","lib/File.htm#Flush",7],
  ["Float","lib/Float.htm",2],
  ["Float","lib/Float.htm",6],
  ["Float32","Structs.htm#numeric-types",6],
  ["Float64","Structs.htm#numeric-types",6],
  ...
  ["Get accessor","Objects.htm#Custom_Classes_property"],
  ...
  ["GetClientPos method (Gui.Control)","lib/GuiControl.htm#GetClientPos",7],
  ["GetCount method (Gui.ListView)","lib/ListView.htm#GetCount",7],
  ["GetCount method (Gui.TreeView)","lib/TreeView.htm#GetCount",7],
  ["GetKeyboardLayout","lib/KeyboardLayout.htm#GetKeyboardLayout",2],
  ["GetKeyInfo","lib/KeyboardLayout.htm#GetKeyInfo",2],
  ...
  ["HasExited property (ProcessInfo)","lib/RunScript.htm#HasExited",7],
  ["HashMap","lib/HashMap.htm",6],
  ...
  ["Hint property (Error)","lib/Error.htm#Hint",7],
  ...
  ["Http","lib/Http.htm",6],
  ["Http.Response","lib/Http.htm#Response",6],
  ["HTTP requests","lib/Http.htm"],
  ["HWND (of a control)","misc/ControlID.htm#HWND"],
  ...
  ["Icon property (Gui)","lib/Gui.htm#Icon",7],
  ...
  ["Image class","lib/Image.htm",6],
  ["Image Lists (GUI)","lib/ListView.htm#IL"],
  ["ImageSearch","lib/ImageSearch.htm",2],
  ["import","lib/_Import.htm",5,"",true],
  ["in","Variables.htm#is_in_contains",4],
  ["in (For)","lib/For.htm"],
  ...
  ["Int16","Structs.htm#numeric-types",6],
  ["Int32","Structs.htm#numeric-types",6],
  ["Int64","Structs.htm#numeric-types",6],
  ["Int8","Structs.htm#numeric-types",6],
  ["Integer","lib/Integer.htm",2],
  ["Integer","lib/Integer.htm",6],
  ["integer (check if it is one)","lib/Is.htm"],
  ["integer (Format)","lib/Format.htm"],
  ["internal type names","Program.htm#internal-names"],
  ["Interrupt (Thread)","lib/Thread.htm#Interrupt"],
  ["IntPtr","Structs.htm#numeric-types",6],
  ["is","Variables.htm#is_in_contains",4],
  ["IsAlnum","lib/Is.htm#alnum",2],
  ["IsAlpha","lib/Is.htm#alpha",2],
  ["IsBuiltIn property (Func)","lib/Func.htm#IsBuiltIn",7],
  ["IsClosure property (Func)","lib/Func.htm#IsClosure",7],
  ["IsMethod property (Func)","lib/Func.htm#IsMethod",7],
  ...
  ["Join function","lib/StringFunctions.htm",2],
  ...
  ["KeyError","lib/Error.htm#KeyError",6],
  ...
  ["Keysharp","Keysharp.htm"],
  ["Keysharp build directives","lib/KeysharpDirectives.htm"],
  ["Keysharp capabilities","lib/RequestCapabilities.htm"],
  ["Keysharp command line","Program.htm#cmd"],
  ["Keysharp compatibility differences","KeysharpDifferences.htm"],
  ["Keysharp conditional compilation","lib/Preprocessor.htm"],
  ["Keysharp platform support","Platforms.htm"],
  ["Keysharp variables","Variables.htm#KS"],
  ["KeyOpt method (InputHook)","lib/InputHook.htm#KeyOpt",7],
  ["keystrokes, sending","lib/Send.htm"],
  ["KeyWait","lib/KeyWait.htm",2],
  ["Kill method (ProcessInfo)","lib/RunScript.htm#Kill",7],
  ...
  ["Length property (Struct)","lib/Struct.htm#Length",7],
  ...
  ["MaxIndex method (ComObjArray)","lib/ComObjArray.htm#MaxIndex",7],
  ...
  ["MinIndex method (ComObjArray)","lib/ComObjArray.htm#MinIndex",7],
  ...
  ["Monitor.All","lib/Monitor.htm#All",2],
  ["Monitor.Brightness","lib/Monitor.htm#Control",2],
  ["Monitor.FromId","lib/Monitor.htm#FromId",2],
  ["Monitor.FromMouse","lib/Monitor.htm#FromMouse",2],
  ["Monitor.FromPoint","lib/Monitor.htm#FromPoint",2],
  ["Monitor.FromWindow","lib/Monitor.htm#FromWindow",2],
  ["Monitor.GetVCP","lib/Monitor.htm#Control",2],
  ["Monitor.Id","lib/Monitor.htm#Id",2],
  ["Monitor.OnChange","lib/Monitor.htm#OnChange",2],
  ["Monitor.Scale","lib/Monitor.htm#Scale",2],
  ["Monitor.SetVCP","lib/Monitor.htm#Control",2],
  ...
  ["Number property (OSError)","lib/Error.htm#Number",7],
  ...
  ["ObjSetDataPtr","lib/Object.htm#SetDataPtr",2],
  ["Office key","KeyList.htm#Office"],
  ...
  ["OnMouseDown property (InputHook)","lib/InputHook.htm#OnMouseDown",7],
  ["OnMouseMove property (InputHook)","lib/InputHook.htm#OnMouseMove",7],
  ["OnMouseUp property (InputHook)","lib/InputHook.htm#OnMouseUp",7],
  ["OnMessage","lib/OnMessage.htm",2],
  ["OnMessage (Gui)","lib/GuiOnMessage.htm"],
  ["OnMessage method (Gui)","lib/Gui.htm#OnMessage",7],
  ["OnMessage method (Gui.Control)","lib/GuiControl.htm#OnMessage",7],
  ...
  ["OutputDebugLine","lib/OutputDebug.htm",2],
  ["Overlay","lib/Overlay.htm",6],
  ...
  ["ParseScript","lib/ParseScript.htm",2],
  ...
  ["Pos property (StringBuffer)","lib/StringBuffer.htm#Pos",7],
  ...
  ["ProcessInfo","lib/RunScript.htm#ProcessInfo",6],
  ...
  ["Props","lib/Props.htm",2],
  ["Props method (Any)","lib/Any.htm#Props",7],
  ["Prototype property (Class)","lib/Class.htm#Prototype",7],
  ["Ptr property (Buffer)","lib/Buffer.htm#Ptr",7],
  ["Ptr property (StringBuffer)","lib/StringBuffer.htm#Ptr",7],
  ["Ptr property (DelegateHolder)","lib/CallbackCreate.htm#Ptr",7],
  ["Ptr property (Struct)","lib/Struct.htm#Ptr",7],
  ...
  ["RandomSeed","lib/Random.htm#RandomSeed",2],
  ...
  ["RealThread","lib/RealThread.htm",6],
  ...
  ["RegExMatchCs","lib/RegExCs.htm#RegExMatchCs",2],
  ["RegExMatchInfo","lib/RegExMatch.htm#MatchObject",6],
  ["RegExMatchInfoCs","lib/RegExCs.htm#RegExMatchInfoCs",6],
  ["RegExReplace","lib/RegExReplace.htm",2],
  ["RegExReplaceCs","lib/RegExCs.htm#RegExReplaceCs",2],
  ...
  ["RichEdit controls (GUI)","lib/GuiControls.htm#RichEdit"],
  ["RichEdit events (GUI)","lib/GuiOnEvent.htm#RichEdit_Events"],
  ["RichText property (Gui.RichEdit)","lib/GuiControls.htm#RichEdit_RichText",7],
  ["Round","lib/Math.htm#Round",2],
  ["rounding a number","lib/Math.htm#Round"],
  ["RTrim","lib/Trim.htm",2],
  ["Run","lib/Run.htm",2],
  ["RunAs","lib/RunAs.htm",2],
  ["RunScript","lib/RunScript.htm",2],
  ...
  ["Send","lib/Send.htm",2],
  ["SendEvent","lib/Send.htm",2],
  ["SendEvent mode","lib/SendMode.htm#Event"],
  ["sending data between scripts","lib/OnMessage.htm#ExSendString"],
  ["SendInput","lib/Send.htm",2],
  ["SendInput mode","lib/SendMode.htm#Input"],
  ["SendLevel","lib/SendLevel.htm",2],
  ["SendMessage","lib/SendMessage.htm",2],
  ["SendMode","lib/SendMode.htm",2],
  ["SendPlay","lib/Send.htm",2],
  ["SendPlay mode","lib/SendMode.htm#Play"],
  ["SendText","lib/Send.htm",2],
  ["Set accessor","Objects.htm#Custom_Classes_property"],
  ...
  ["SetBadge method (Taskbar)","lib/Taskbar.htm#SetBadge",7],
  ["SetCue method (Gui.ComboBox)","lib/GuiControl.htm#SetCue",7],
  ["SetCue method (Gui.Edit)","lib/GuiControl.htm#SetCue",7],
  ...
  ["SetFormat method (Gui.RichEdit)","lib/GuiControls.htm#RichEdit_SetFormat",7],
  ["SetIcon method (Gui)","lib/Gui.htm#SetIcon",7],
  ["SetIcon method (Gui.StatusBar)","lib/GuiControls.htm#SB_SetIcon",7],
  ...
  ["SetParts method (Gui.StatusBar)","lib/GuiControls.htm#SB_SetParts",7],
  ...
  ["SetText method (Gui.StatusBar)","lib/GuiControls.htm#SB_SetText",7],
  ...
  ["Size property (StringBuffer)","lib/StringBuffer.htm#Size",7],
  ["Size property (Struct)","lib/Struct.htm#Size",7],
  ...
  ["StdErr property (ProcessInfo)","lib/RunScript.htm#StdErr",7],
  ["StdIn property (ProcessInfo)","lib/RunScript.htm#StdIn",7],
  ["StdOut property (ProcessInfo)","lib/RunScript.htm#StdOut",7],
  ["space","lib/Is.htm"],
  ...
  ["Source property (Enumerator)","lib/Enumerator.htm#Source",7],
  ["Stack property (Error)","lib/Error.htm#Stack",7],
  ["Success property (Match)","lib/RegExMatch.htm#Success",7],
  ...
  ["Status property (Task)","lib/Task.htm#Status",7],
  ["Status property (WinEvent)","lib/WinEvent.htm#Hook",7],
  ...
  ["StringBuffer","lib/StringBuffer.htm",6],
  ...
  ["struct","Structs.htm#classdef",5,"",true],
  ["Struct","lib/Struct.htm",6],
  ["Struct.Array","lib/StructArray.htm",6],
  ["Struct.Ptr","Structs.htm#pointers",6],
  ...
  ["syntax highlighting (GUI)","lib/GuiControls.htm#RichEdit_Highlighting"],
  ...
  ["Task","lib/Task.htm",6],
  ["Task property (RealThread)","lib/RealThread.htm#Task",7],
  ...
  ["Terminated property (RealThread)","lib/RealThread.htm#Terminated",7],
  ...
  ["this (hidden parameter)","Objects.htm#Custom_Classes_method"],
  ...
  ["TranscribeModifiedKeys property (InputHook)","lib/InputHook.htm#TranscribeModifiedKeys",7],
  ...
  ["ToClr method","lib/Clr.htm#ToClr",7],
  ["ToClr method (Array)","lib/Array.htm#ToClr",7],
  ["ToClr method (Gui)","lib/Gui.htm#ToClr",7],
  ["ToClr method (GuiControl)","lib/GuiControl.htm#ToClr",7],
  ["ToClr method (Map)","lib/Map.htm#ToClr",7],
  ["ToClr method (Menu)","lib/Menu.htm#ToClr",7],
  ["ToClr method (Task)","lib/Task.htm#ToClr",7],
  ["ToggleCheck method (Menu)","lib/Menu.htm#ToggleCheck",7],
  ["ToggleEnable method (Menu)","lib/Menu.htm#ToggleEnable",7],
  ["ToString method (Array)","lib/Array.htm#ToString",7],
  ["ToString method (Error)","lib/Error.htm#ToString",7],
  ["ToString method (Match)","lib/RegExMatch.htm#MatchToString",7],
  ["ToString method (Map)","lib/Map.htm#ToString",7],
  ["ToolTip","lib/ToolTip.htm",2],
  ["transparency of a window","lib/WinSetTransparent.htm"],
  ["tray icon","Program.htm#tray-icon"],
  ["TrayIcon directive","lib/_TrayIcon.htm"],
  ...
  ["type specifiers (structs)","Structs.htm#type-specs"],
  ["TypeError","lib/Error.htm#TypeError",6],
  ["UInt16","Structs.htm#numeric-types",6],
  ["UInt32","Structs.htm#numeric-types",6],
  ...
  ["value (implicit Set parameter)","Objects.htm#Custom_Classes_property"],
  ["Value property (Gui.Control)","lib/GuiControl.htm#Value",7],
  ["ValueError","lib/Error.htm#ValueError",6],
  ["VarType property (ComValue)","lib/ComValue.htm#VarType",7],
  ...
  ["VisibleMouseMove property (InputHook)","lib/InputHook.htm#VisibleMouseMove",7],
  ...
  ["WebKitGTK (WebView engine on Linux)","lib/GuiControls.htm#WebView_Engine"],
  ["WebView controls (GUI)","lib/GuiControls.htm#WebView"],
  ["WebView events (GUI)","lib/GuiOnEvent.htm#WebView_Events"],
  ...
  ["WinEvent","lib/WinEvent.htm",6],
  ["WinExist","lib/WinExist.htm",2],
  ["WinFromPoint","lib/WinFromPoint.htm",2],
  ...
  ["WinMaximizeAll","lib/WinMaximizeAll.htm",2],
  ...
  ["WinTitle parameter","misc/WinTitle.htm"],
  ...
  ["WM_COPYDATA","lib/SendMessage.htm#WM_COPYDATA"],
